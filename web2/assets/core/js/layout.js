...
vm.menu = ko.observableArray([{ title: 'Dashboard', icon: 'home', href: viewModel.appName + 'page/dashboard', submenu: [] }, { title: 'Analysis', icon: 'bar-chart-o', href: '#', submenu: [{ title: 'P&L Analysis', icon: 'bar-chart-o', href: viewModel.appName + 'page/pnlanalysis', submenu: [] }, { title: 'Key Account Analysis', icon: 'bar-chart-o', href: viewModel.appName + 'page/keyaccountanalysis', submenu: [] }, { title: 'Branch Analysis', icon: 'bar-chart-o', href: viewModel.appName + 'page/branchanalysis', submenu: [] }, { title: 'RD Analysis', icon: 'bar-chart-o', href: viewModel.appName + 'page/rdanalysis', submenu: [] }, { title: 'Custom Analysis', icon: 'bar-chart-o', href: viewModel.appName + 'page/customanalysis', submenu: [] }] },
