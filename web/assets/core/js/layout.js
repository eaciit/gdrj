...
vm.menu = ko.observableArray([{ title: 'Dashboard', icon: 'home', href: '#', submenu: [] }, { title: 'Data', icon: 'user', href: '#', submenu: [{ title: 'Data Browser', href: '#', submenu: [] }, { title: 'Data Serializer', href: '#', submenu: [] }, { title: 'Web Grabber', href: '#', submenu: [] }, { title: 'File Browser', href: '#', submenu: [] }] }, { title: 'Admin', icon: 'gear', href: '#', submenu: [] }]);
