...
vm.menu = ko.observableArray([{ title: 'Dashboard', icon: 'home', href: '/web/report/dashboard', submenu: [] }, { title: 'Report', icon: 'file-text-o', href: '#', submenu: [{ title: 'Distribution', icon: 'user', href: '/web/report/list', submenu: [] }, { title: 'General Trade', icon: 'list', href: '/web/report/list', submenu: [] }, { title: 'Market Efficiency', icon: 'shopping-basket', href: '/web/report/list', submenu: [] }, { title: 'SG & A', icon: 'list', href: '/web/report/list', submenu: [] }, { title: 'Chart Comparison', icon: 'bar-chart-o', href: '/web/reportchartcomparison', submenu: [] }] }, { title: 'Data Manager', icon: 'database', href: '#', submenu: [{ title: 'Data Browser', icon: 'list', href: '/web/databrowser', submenu: [] }, { title: 'Upload Data', icon: 'upload', href: '/web/uploaddata', submenu: [] }] }, { title: 'Organization', icon: 'sitemap', href: '/web/organization', submenu: [] }, { title: 'Administration', icon: 'gear', href: '#', submenu: [{ title: 'Allocation Flow', icon: 'arrows', href: '/web/allocationflow', submenu: [] }, { title: 'Access', icon: 'unlock-alt', href: '/web/access', submenu: [] }, { title: 'Group', icon: 'users', href: '/web/group', submenu: [] }, { title: 'User', icon: 'user', href: '/web/user', submenu: [] }, { title: 'Session', icon: 'clock-o', href: '/web/session', submenu: [] }, { title: 'Log', icon: 'book', href: '/web/log', submenu: [] }] }]);
