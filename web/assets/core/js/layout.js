...
vm.menu = ko.observableArray([{ title: 'Home', icon: 'home', href: viewModel.appName + 'page/home', submenu: [] }, { title: 'P&L Performance', icon: 'tachometer', href: viewModel.appName + 'page/pnlperformance', submenu: [] }, { title: 'YoY Rev & EBIT', icon: 'bar-chart-o', href: viewModel.appName + 'page/yearcompare', submenu: [] }, { title: 'Marketing Efficiency', icon: 'bar-chart-o', href: viewModel.appName + 'page/marketingefficiency', submenu: [] }, { title: 'Analysis', icon: 'bar-chart-o', href: '#', submenu: [{ "title": "Branch Analysis", "icon": "bar-chart-o", "href": "/web/page/branchanalysis", "submenu": [] }, { "title": "Branch Group Analysis", "icon": "bar-chart-o", "href": "/web/page/branchgroupanalysis", "submenu": [] }, { "title": "Branch vs RD Analysis", "icon": "bar-chart-o", "href": "/web/page/rdvsbranchanalysis", "submenu": [] }, { "title": "Brand Analysis", "icon": "bar-chart-o", "href": "/web/page/brandanalysis", "submenu": [] }, { "title": "COGS Analysis", "icon": "bar-chart-o", "href": "/web/page/cogsanalysis", "submenu": [] }, { "title": "Contribution Analysis", "icon": "bar-chart-o", "href": "/web/page/contributionanalysis", "submenu": [] }, { "title": "Custom Analysis", "icon": "bar-chart-o", "href": "/web/page/customanalysis", "submenu": [] }, { "title": "Distribution Analysis", "icon": "bar-chart-o", "href": "/web/page/distributionanalysis", "submenu": [] }, { "title": "G&A Analysis", "icon": "bar-chart-o", "href": "/web/page/gnaanalysis", "submenu": [] }, { "title": "Growth Analysis", "icon": "bar-chart-o", "href": "/web/page/growthanalysis", "submenu": [] },
	...
	{ "title": "RD Analysis", "icon": "bar-chart-o", "href": "/web/page/rdanalysis", "submenu": [] }, { "title": "Sales Return Analysis", "icon": "bar-chart-o", "href": "/web/page/salesreturnanalysis", "submenu": [] }] }, { title: 'Analysis Ideas', icon: 'bar-chart-o', href: viewModel.appName + 'page/reportdynamic?p=sales-by-outlet', submenu: [] },
