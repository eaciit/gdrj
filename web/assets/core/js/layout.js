...
vm.menu = ko.observableArray([{ title: 'Dashboard', icon: 'home', href: '#', submenu: [] }, { title: 'Distributor', icon: 'user', href: '#', submenu: [] }, { title: 'General Trade', icon: 'list', href: '#', submenu: [] }, { title: 'Market Efficiency', icon: 'shopping-basket', href: '#', submenu: [] }, { title: 'SG & A', icon: 'list', href: '#', submenu: [] }, { title: 'Data Manager', icon: 'database', href: '#', submenu: [{ title: 'Data Browser', icon: 'list', href: '/web/databrowser', submenu: [] }, { title: 'Upload Data', icon: 'upload', href: '/web/uploaddata', submenu: [] }] }, { title: 'Administration', icon: 'home', href: '#', submenu: [{ title: 'Allocation Flow', icon: 'arrows', href: '#', submenu: [] }, { title: 'Access', icon: 'universal-access', href: '#', submenu: [] }, { title: 'Group', icon: 'users', href: '#', submenu: [] }, { title: 'User', icon: 'user', href: '#', submenu: [] }, { title: 'Session', icon: 'clock-o', href: '#', submenu: [] }] }]);
