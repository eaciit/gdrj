...
ra.optionDimensions = ko.observableArray([{ field: "customer.branchname", name: 'Branch/RD' }, { field: "product.brand", name: 'Brand' }, { field: 'customer.channelname', name: 'Channel' }, { field: 'customer.name', name: 'Outlet' }, { field: 'product.name', name: 'Product' }, { field: 'customer.region', name: 'Region' }]);
