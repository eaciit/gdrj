...
ra.optionDimensions = ko.observableArray([{ field: "customer.branchname", name: 'Branch/RD' }, { field: 'customer.channelname', name: 'Channel' }, { field: 'customer.area', name: 'Geography' }, { field: 'product.name', name: 'Product' }, { field: 'date.date', name: 'Time' }, { field: '', name: 'Cost Type' }, // <<<<< ====================== need to be filled
