...
dsbrd.render = function () {
	var target = $('.grid-dashboard').empty();
...
rank.optionSort = ko.observableArray([{ field: 'asc', name: 'Low margin to high' }, { field: 'desc', name: 'High margin to low' }]);
