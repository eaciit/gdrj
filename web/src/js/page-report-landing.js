...
lgd.menu = ko.observableArray([
	...
	{ to: 'distributionanalysis', title: 'Distribution Analysis', icon: 'fa-bus', color: 'rgb(23, 142, 73)' },
	{ to: 'contributionanalysis', title: 'Contribution Analysis', icon: 'fa-plus', color: 'rgb(212, 130, 0)' },
	{ to: 'growthanalysis', title: 'Growth Analysis', icon: 'fa-area-chart', color: '#b70f5d' },
	
	{ to: 'keyaccountanalysis', title: 'Key Account Analysis', icon: 'fa-key', color: 'rgb(17, 134, 212)' },
	{ to: 'salesreturnanalysis', title: 'Sales Return Analysis', icon: 'fa-refresh', color: 'rgb(32, 162, 87)' },
	{ to: 'branchanalysis', title: 'Branch Analysis', icon: 'fa-home', color: '#F39C12' },
