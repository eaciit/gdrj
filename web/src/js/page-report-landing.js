...
lgd.menu = ko.observableArray([
	...
	{ to: 'growth-analysis', title: 'Growth Analysis', nope: true, icon: 'fa-area-chart', color: 'rgb(23, 142, 73)' },
	{ to: 'key-account-analysis', title: 'Key Account Analysis', icon: 'fa-key', color: 'rgb(32, 162, 87)' },
	...
	{ to: 'branch-analysis', title: 'Branch Analysis', icon: 'fa-home', color: 'rgb(234, 144, 0)' },
	{ to: 'ad-hoc-analysis', title: 'Ad Hoc Analysis', icon: 'fa-gear', color: '#F39C12' },
])
